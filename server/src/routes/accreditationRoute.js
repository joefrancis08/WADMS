...
import { addProgramAreaController } from '../controllers/accreditation/program-area-mapping/programAreaMappingController.js';
...
accreditationRouter.post('/add-program-area', addProgramAreaController);
