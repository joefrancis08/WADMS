...
import { addLevel, fetchLevels } from '../controllers/accreditation/level/levelController.js';
...
import { fetchPeriod } from '../controllers/accreditation/period/periodController.js';

const accreditationRouter = express.Router();

accreditationRouter.post('/add-accreditation-level', addLevel);
accreditationRouter.get('/fetch-accreditation-levels', fetchLevels);
accreditationRouter.get('/fetch-accreditation-period', fetchPeriod);
