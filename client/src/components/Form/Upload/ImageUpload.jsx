  ...
  return (
    <div className="flex items-center justify-center">
      <div className="relative flex flex-col w-1/2 items-center space-y-2 border border-gray-400 rounded-lg p-2 mb-4 shadow">
        ...
        {/* Upload Button */}
        <label className="flex items-center gap-2 border border-slate-400 px-5 py-2 rounded-full text-slate-800 cursor-pointer hover:bg-slate-100 transition hover:shadow-slate-100 shadow-md active:scale-98">
          {preview ? (
            <>
              <Pen size={20} />
              Change
