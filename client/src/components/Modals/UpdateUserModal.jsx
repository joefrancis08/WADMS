...
// Header
const UpdateUserModalHeader = ({ onClose, headerName }) => {
  return (
    <>
      <button
        onClick={onClose}
...
// Footer 
const UpdateUserModalFooter = ({ onCancelClick, onSaveClick, primaryButtonName, secondaryButtonName }) => {
  return (
    <>
      <button
...
const UpdateUserModal = ({ 
  ...
  return (
    <>
      <ModalLayout 
        onClose={onClose}
        header={<UpdateUserModalHeader onClose={onClose} headerName={header}/>}
        headerMargin={'mt-0'}
        headerPosition={'justify-start'}
        body={<UpdateUserModalBody bodyContent={body}/>}
        bodyMargin={'my-4'}
