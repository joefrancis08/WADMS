  ...
  return (
    <>
      <button
        ...
        className="flex items-center justify-center bg-gradient-to-br from-gray-500 to-gray-400 text-white px-10 py-2 rounded-lg text-sm hover:bg-gradient-to-tr hover:from-gray-500 hover:to-gray-400 hover:shadow-lg active:opacity-50 transition cursor-pointer"
      >
        {secondaryButton}
      </button>
      ...
      <button
        ...
        className={`flex items-center justify-center text-white px-10 py-2 rounded-lg text-sm hover:shadow-lg active:opacity-50 transition-all duration-300 cursor-pointer 
